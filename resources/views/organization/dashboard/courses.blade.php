        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:max-w-full lg:px-8 lg:grid lg:grid-cols-12 lg:gap-8">
            ...
            <main class="lg:col-span-9 xl:col-span-6">
                <div class="py-4 sm:py-6 md:py-8 lg:py-10">
                    <x-partials.development-card description="List of courses given by a school"
                        duration="1 month + testing + feedback improvements" start="Mid april"
                        link="https://trello.com/c/pXDoaFXI" />
                </div>
            </main>
