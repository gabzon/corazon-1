<div class="pb-8 space-y-1">
    ...
    <a href="{{ route('course.info', $event) }}"
    ...
    <a href="{{ route('course.students', $event) }}"
        class="{{ Request::is('event/*/students') ? 'bg-gray-200 text-gray-900' : 'text-gray-600 hover:bg-gray-50' }} group flex items-center px-3 py-2 text-sm font-medium rounded-md">
    ...
    <a href="{{ route('course.stats', $event) }}"
