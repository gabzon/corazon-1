<div>
    ...
    <div class="grid grid-cols-12 gap-6 items-center">
                        ...
                        <div x-data="selectConfigs()" x-init="fetchOptions()"
                            ...
                            <div class="w-full">
                                <div @click.away="close()"
                                    class="my-2 p-1 bg-white flex border border-gray-300 rounded">
                                                ...
                                                <div class="w-full items-center flex">
                                                    <div class="mx-2 -mt-1"><span x-text="option.name"></span>
                                                        <div class="text-xs truncate w-full normal-case font-normal -mt-1 text-gray-500"
                                                            x-text="option.city + ', ' + option.country"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="col-span-3">
            <button type="button" wire:click="addManager"
    ...
    <script>
        function selectConfigs() {
            return {
                ...
                fetchOptions() {
                    fetch('https://corazon.test/api/select-organizations')                    
                ...
                filteredOptions() {
                    return this.options ? this.options.filter(
                        option => {
                                return (option.name.toLowerCase().indexOf(this.filter) > -1) || (option.city.toLowerCase().indexOf(this.filter) > -1) || (option.country.toLowerCase().indexOf(this.filter) > -1)
                            }
                        ) : {}
                    },
