...
class Events extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.schedule.events', [
            'parties'   => Event::IsActive()->where('type','party')->latest()->get(),
            'workshops' => Event::IsActive()->where('type',"workshop")->latest()->get(),
            'festivals' => Event::IsActive()->where('type',"festival")->latest()->get(),
        ]);
    }
}
